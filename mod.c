...
int cgiMain()
{
	...
	sprintf(sql, "update Student set stuName='%s', stuSex= '%s',stuBorn= '%s', stuPolSta='%s',stuAdr='%s',stutel='%s',stumajor= '%s' where stuID = '%s'", stuName,stuSex,stuBorn,stuPolSta,stuAdr,stutel,stumajor,stuID);
